      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center animate-slide-in-up">
          <h1 className="text-5xl font-bold mb-6">
            <span className="text-[#B22429]">Contact</span> <span className="text-[#032F65]">Us</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto animate-slide-in-up">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="glass p-8 rounded-3xl">
              <h2 className="text-2xl font-bold mb-4 gradient-text">Send us a Message</h2>
        ...
        <div className="max-w-4xl mx-auto animate-slide-in-up">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              <span className="gradient-text">Frequently Asked</span> <span className="text-blue-900">Questions</span>
