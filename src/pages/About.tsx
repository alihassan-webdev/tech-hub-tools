  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            ToolsHub brings together the most essential utilities for developers, 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ToolsHub was born out of frustration with the fragmented landscape of online tools. 
                ...
                <p>
                  ...
                  After months of development, ToolsHub emerged as the ultimate productivity companion.
                </p>
                <p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">
            Built by <span className="gradient-text">Tech-Hub Developers</span>
          </h2>
          ...
          <div className="glass p-8 rounded-3xl">
            ...
            <p className="text-sm text-accent font-semibold">- The ToolsHub Team</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass p-12 rounded-3xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join thousands of users who have already discovered the power of ToolsHub.
            </p>
