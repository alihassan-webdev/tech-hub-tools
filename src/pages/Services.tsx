      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center animate-slide-in-up">
          <h1 className="text-5xl font-bold mb-6">
            <span className="gradient-text">Our</span> <span className="text-[#032F65]">Services</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto animate-slide-in-up">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Why Choose <span className="text-[#B22429]">Tech</span><span className="text-[#032F65]">-Hub Tools</span>?
            </h2>
