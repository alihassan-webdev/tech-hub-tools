      ...
      <div className="glass p-6 rounded-3xl space-y-4">
        ...
        <div className="mt-6">
          <div className="bg-white p-4 rounded-lg shadow-sm text-left">
            <a className="text-blue-600 text-lg font-medium block truncate">{title || (<>Example Title - <span className="text-[#B22429]">Tech</span><span className="text-[#032F65]">-Hub Tools</span></>)}</a>
